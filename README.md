...
[Reflecto](https://devkidd.itch.io/reflecto) by [Devkidd](https://devkidd.itch.io/)

Reflecto is a lightweight and handy Aseprite extension that automatically creates vertical reflections of your sprite artwork in just a click. Whether you’re working on mirror effects, water scenes, or stylized UIs, Reflecto saves you time by handling the flip, blur, and alignment for you.

`reflection` `mirror`

---

[SmartGuides](https://yukipixels.itch.io/smart-guides-script) by [Yūki](https://yukipixels.itch.io/)

SmartGuides is a Guide Script that visually adds customizable crosshairs and square to your canvas, with enhanced flexibility and usability.

`editor` `guides`

---

[Immediately name new layers](https://community.aseprite.org/t/script-immediately-name-new-layers/25650) by [mindstorm](https://community.aseprite.org/u/mindstorm/profile-hidden)
...
`editor` `layers` `organization`

---

[Distralign](https://devkidd.itch.io/distralign) by [Devkidd](https://devkidd.itch.io/)

Distralign is an Aseprite extension that lets you align and distribute cels with precision. Whether you’re spacing out cels evenly, aligning them to an active layer, or distributing them based on direction, Distralign makes sprite organization effortless.

`editor` `guides` `alignment`

---

[Normal Map Inspector](https://ppelikan.itch.io/normal-map-inspector) by [ppelikan](https://ppelikan.itch.io/)

Normal Map Inspector is a tool that simplifies work with normal maps.

`normals` `palette`

---

[Parallixel](https://devkidd.itch.io/parallixel) by [Devkidd](https://devkidd.itch.io/)
...
[NTDinh's Aseprite Script](https://github.com/ntd280804/Aseprite-Export-Combinations) by [Nguyễn Trần Dinh](https://github.com/ntd280804)

A free Aseprite script for exporting spritesheets. If you’re building 2D games with modular or customizable characters, this is for you!

`export`

---

[Live Draw](https://devkidd.itch.io/live-draw) by [Devkidd](https://devkidd.itch.io/)
...
[LPC2ASE](https://github.com/IoriBranford/aseprite-import-lpc-character) by [IoriBranford](https://github.com/IoriBranford)

This tool makes Aseprite files of characters generated by [Universal LPC Sprite Sheet Character Generator](https://liberatedpixelcup.github.io/Universal-LPC-Spritesheet-Character-Generator/).

`import` `drawing`

---

[Wave Warp](https://devkidd.itch.io/wave-warp) by [Devkidd](https://devkidd.itch.io/)

Wave Warp is an Aseprite extension that lets you create animated wave distortions with precision and style.

`distortion` `wave`

---

[Aseprite Gradients Extension](https://tliad.itch.io/aseprite-gradients-extension) by [TLiaD](https://tliad.itch.io/)

A Gradient Tool Extension with over 100 dither patterns!

`gradients` `drawing`

---

[Tweencel](https://devkidd.itch.io/tweencel) by [Devkidd](https://devkidd.itch.io/)
...
[Normal Map Preview](https://yahallogames.itch.io/normal-map-preview-aseprite-extension) by [Yahallo Games](https://yahallogames.itch.io/)

Normal Map Preview allows you to preview the result of the normal map within Aseprite

`editor` `normals`

---

[Import PSD](https://github.com/Tin-01/aseprite-psd-scripts) by [Tin-01](https://github.com/Tin-01)

Script to re-import PSD files that were previously exported using Export as psd.lua (Aseprite → PSD) back into Aseprite.
